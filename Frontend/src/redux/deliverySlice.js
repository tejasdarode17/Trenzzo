...
export const fetchOngoingDeliveryOrders = createAsyncThunk("fetch-ongoing-orders",
    async (_, { rejectWithValue }) => {
        try {
            const response = await api.get("/delivery/pending-orders");
...
export const fetchAllDeliveryOrders = createAsyncThunk("fetch-all-orders",
    async (_, { rejectWithValue }) => {
        try {
...
export const fetchReturnOrders = createAsyncThunk("fetch-return-orders",
    async (_, { rejectWithValue }) => {
        try {
            const response = await api.get("/delivery/all-returns");
